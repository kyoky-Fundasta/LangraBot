...
# This model use more parameters than my_agent to generate the most possible answer.
...
def ai_advanced_agent(chat_state: GraphState) -> GraphState:
    ...
    result = agent_executor.invoke(
        {
            "question": chat_state["rewrotten_question"],
...
if __name__ == "__main__":
    ...
    user_input = (
        "名古屋市にある山本幸次さんがCEOをやっているSES会社に育児休暇はありますか"
    )
    rewrotten_input = (
        "名古屋市にある山本幸次さんがCEOをやっているSES会社の名前はなんですか"
    )
    answer = "申し訳ありませんが、名古屋市の山本幸司さんがCEOをやっているSES会社に関する情報が見つかりませんでした。そのため、育児休暇の有無についてお答えすることはできません。"
